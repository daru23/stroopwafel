...
const VERBS = [
  ...
  // --- remaining verbs from the A2 "onregelmatige werkwoorden" list ---
  { inf: 'bakken', en: 'to bake / fry', present: 'bakt', imp: 'bakte / bakten', part: 'gebakken', aux: 'hebben' },
  { inf: 'bezoeken', en: 'to visit', present: 'bezoekt', imp: 'bezocht / bezochten', part: 'bezocht', aux: 'hebben' },
  { inf: 'bidden', en: 'to pray', present: 'bidt', imp: 'bad / baden', part: 'gebeden', aux: 'hebben' },
  { inf: 'blijken', en: 'to turn out / appear', present: 'blijkt', imp: 'bleek / bleken', part: 'gebleken', aux: 'zijn' },
  { inf: 'braden', en: 'to roast', present: 'braadt', imp: 'braadde / braadden', part: 'gebraden', aux: 'hebben' },
  { inf: 'duiken', en: 'to dive', present: 'duikt', imp: 'dook / doken', part: 'gedoken', aux: 'hebben/zijn' },
  { inf: 'ervaren', en: 'to experience', present: 'ervaart', imp: 'ervoer / ervoeren', part: 'ervaren', aux: 'hebben' },
  { inf: 'fluiten', en: 'to whistle', present: 'fluit', imp: 'floot / floten', part: 'gefloten', aux: 'hebben' },
  { inf: 'gelden', en: 'to apply / be valid', present: 'geldt', imp: 'gold / golden', part: 'gegolden', aux: 'hebben' },
  { inf: 'genezen', en: 'to heal / cure', present: 'geneest', imp: 'genas / genazen', part: 'genezen', aux: 'hebben/zijn' },
  { inf: 'heten', en: 'to be called', present: 'heet', imp: 'heette / heetten', part: 'geheten', aux: 'hebben' },
  { inf: 'klimmen', en: 'to climb', present: 'klimt', imp: 'klom / klommen', part: 'geklommen', aux: 'hebben' },
  { inf: 'klinken', en: 'to sound', present: 'klinkt', imp: 'klonk / klonken', part: 'geklonken', aux: 'hebben' },
  { inf: 'liegen', en: 'to lie (tell an untruth)', present: 'liegt', imp: 'loog / logen', part: 'gelogen', aux: 'hebben' },
  { inf: 'lijden', en: 'to suffer', present: 'lijdt', imp: 'leed / leden', part: 'geleden', aux: 'hebben' },
  { inf: 'lijken', en: 'to seem / resemble', present: 'lijkt', imp: 'leek / leken', part: 'geleken', aux: 'hebben' },
  { inf: 'meten', en: 'to measure', present: 'meet', imp: 'mat / maten', part: 'gemeten', aux: 'hebben' },
  { inf: 'ontwerpen', en: 'to design', present: 'ontwerpt', imp: 'ontwierp / ontwierpen', part: 'ontworpen', aux: 'hebben' },
  { inf: 'opschieten', en: 'to hurry up', present: 'schiet op', imp: 'schoot op / schoten op', part: 'opgeschoten', aux: 'hebben/zijn' },
  { inf: 'overlijden', en: 'to pass away', present: 'overlijdt', imp: 'overleed / overleden', part: 'overleden', aux: 'zijn' },
  { inf: 'raden', en: 'to guess / advise', present: 'raadt', imp: 'raadde / raadden', part: 'geraden', aux: 'hebben' },
  { inf: 'ruiken', en: 'to smell', present: 'ruikt', imp: 'rook / roken', part: 'geroken', aux: 'hebben' },
  { inf: 'scheiden', en: 'to separate / divorce', present: 'scheidt', imp: 'scheidde / scheidden', part: 'gescheiden', aux: 'hebben/zijn' },
  { inf: 'schenken', en: 'to pour / donate', present: 'schenkt', imp: 'schonk / schonken', part: 'geschonken', aux: 'hebben' },
  { inf: 'scheren', en: 'to shave', present: 'scheert', imp: 'schoor / schoren', part: 'geschoren', aux: 'hebben' },
  { inf: 'schrikken', en: 'to be startled', present: 'schrikt', imp: 'schrok / schrokken', part: 'geschrokken', aux: 'zijn' },
  { inf: 'schuiven', en: 'to slide / push', present: 'schuift', imp: 'schoof / schoven', part: 'geschoven', aux: 'hebben/zijn' },
  { inf: 'smelten', en: 'to melt', present: 'smelt', imp: 'smolt / smolten', part: 'gesmolten', aux: 'hebben' },
  { inf: 'smijten', en: 'to throw / chuck', present: 'smijt', imp: 'smeet / smeten', part: 'gesmeten', aux: 'hebben' },
  { inf: 'snuiten', en: 'to blow (one’s nose)', present: 'snuit', imp: 'snoot / snoten', part: 'gesnoten', aux: 'hebben' },
  { inf: 'springen', en: 'to jump', present: 'springt', imp: 'sprong / sprongen', part: 'gesprongen', aux: 'hebben/zijn' },
  { inf: 'stelen', en: 'to steal', present: 'steelt', imp: 'stal / stalen', part: 'gestolen', aux: 'hebben' },
  { inf: 'sterven', en: 'to die', present: 'sterft', imp: 'stierf / stierven', part: 'gestorven', aux: 'zijn' },
  { inf: 'stinken', en: 'to stink', present: 'stinkt', imp: 'stonk / stonken', part: 'gestonken', aux: 'hebben' },
  { inf: 'strijken', en: 'to iron', present: 'strijkt', imp: 'streek / streken', part: 'gestreken', aux: 'hebben' },
  { inf: 'treden', en: 'to step / tread', present: 'treedt', imp: 'trad / traden', part: 'getreden', aux: 'hebben/zijn' },
  { inf: 'varen', en: 'to sail', present: 'vaart', imp: 'voer / voeren', part: 'gevaren', aux: 'hebben/zijn' },
  { inf: 'vechten', en: 'to fight', present: 'vecht', imp: 'vocht / vochten', part: 'gevochten', aux: 'hebben' },
  { inf: 'verbieden', en: 'to forbid', present: 'verbiedt', imp: 'verbood / verboden', part: 'verboden', aux: 'hebben' },
  { inf: 'verdwijnen', en: 'to disappear', present: 'verdwijnt', imp: 'verdween / verdwenen', part: 'verdwenen', aux: 'zijn' },
  { inf: 'vergelijken', en: 'to compare', present: 'vergelijkt', imp: 'vergeleek / vergeleken', part: 'vergeleken', aux: 'hebben' },
  { inf: 'vertrekken', en: 'to depart / leave', present: 'vertrekt', imp: 'vertrok / vertrokken', part: 'vertrokken', aux: 'zijn' },
  { inf: 'verzinnen', en: 'to make up / invent', present: 'verzint', imp: 'verzon / verzonnen', part: 'verzonnen', aux: 'hebben' },
  { inf: 'verzoeken', en: 'to request', present: 'verzoekt', imp: 'verzocht / verzochten', part: 'verzocht', aux: 'hebben' },
  { inf: 'waaien', en: 'to blow (of wind)', present: 'waait', imp: 'waaide / waaiden', part: 'gewaaid', aux: 'hebben' },
  { inf: 'zenden', en: 'to send / broadcast', present: 'zendt', imp: 'zond / zonden', part: 'gezonden', aux: 'hebben' },
  { inf: 'zwijgen', en: 'to be silent', present: 'zwijgt', imp: 'zweeg / zwegen', part: 'gezwegen', aux: 'hebben' },
];
